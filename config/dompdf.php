...
return [
    ...
    */
    ...
    'font_family' => [
        'Montserrat' => [
            'normal' => storage_path('app/fonts/Montserrat-Regular.ttf'),
            'bold' => storage_path('app/fonts/Montserrat-SemiBold.ttf'),
        ],
        'Playfair Display' => [
            'normal' => storage_path('app/fonts/PlayfairDisplay-Regular.ttf'),
            'bold' => storage_path('app/fonts/PlayfairDisplay-Bold.ttf'),
        ],
    ],
];
