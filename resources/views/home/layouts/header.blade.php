...
<div class="top-bar">
    <div class="container top-bar-content">
        <div class="top-center">
            {{ $bannerHeader->deskripsi ?? 'Default text Jika Deskripsi Kosong' }}
        </div>
    ...
    <div class="container nav-content">
        ...
        <nav class="nav-links">
            ...
            <a href="{{ route('collection') }}"
                class="nav-item {{ request()->is('collection') ? 'active' : '' }}">Collection</a>
            <a href="{{ route('invoice') }}"
                class="nav-item {{ request()->is('invoice') ? 'active' : '' }}">Transaction</a>
