            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="4" class="border border-gray-300 rounded-xl px-3 py-2 w-full" required>{{ $produk->deskripsi }}</textarea>
                    </div>
                            ...
                            @foreach ($ukuran as $itemUkuran)
                                <label class="flex items-center gap-2 border px-3 py-1 rounded-xl cursor-pointer">
                                    <input type="checkbox" name="ukuran_id[]" value="{{ $itemUkuran->ukuran_id }}"
                                        {{ optional($produk->ukuran)->pluck('ukuran_id')->contains($itemUkuran->ukuran_id) ? 'checked' : '' }}>
