    ...
    <div class="p-8 bg-white rounded-lg shadow">
        ...
        <div class="grid gap-5 grid-cols-[repeat(auto-fill,minmax(220px,1fr))]">
            ...
            @else
                @foreach ($produk as $p)
                    <div
                        class="p-2 bg-slate-200 rounded-xl shadow-md overflow-visible hover:bg-[#DFE3E7] transition duration-200">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <div x-data="{ open: false }" class="relative inline-block text-left">
                                ...
                                <div x-show="open" @click.away="open = false" x-cloak
                                    class="absolute right-0 mt-2 w-44 bg-white border border-gray-200 rounded-lg shadow-lg z-50 transition-all duration-200 ease-out">
