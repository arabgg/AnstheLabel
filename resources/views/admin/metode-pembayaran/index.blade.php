...
<div class="p-8 bg-white rounded-lg shadow">
    ...
    <div class="flex justify-end mb-7 mt-12">
        <form method="GET" action="{{ route('metode-pembayaran.index') }}" class="mr-3 flex items-center border rounded-lg px-3 py-2 w-1/3">
        ...
        <a href="{{ url('/metode-pembayaran/create') }}"
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="p-3 mt-5 flex gap-2 justify-center items-center">
                            ...
                            <button 
                                ...
                                onclick="openMetodeModal('{{ route('metode-pembayaran.show', ['id' => $item->metode_pembayaran_id]) }}')">
                            ...
                            <button
                                ...
                                onclick="openMetodeModal('{{ route('metode-pembayaran.edit', ['id' => $item->metode_pembayaran_id]) }}')">
                            ...
                            <button 
                                ...
                                onclick="deleteMetode('{{ route('metode-pembayaran.destroy', $item->metode_pembayaran_id) }}')">
                    ...
                    form.addEventListener('submit', function(e){
                        ...
                        .then(data => {
                            ...
                            if(data.success){
                                ...
                                const row = document.querySelector(`[data-metode-id='${data.data.metode_pembayaran_id}']`);
                                if(row){
