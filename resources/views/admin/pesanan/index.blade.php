    ...
    <div class="p-8 bg-white rounded-lg shadow">
        ...
        <div class="flex justify-end mb-5">
            <form method="GET" action="{{ route('pesanan.index') }}"
                ...
                <input type="text" name="search" placeholder="Search Pesanan Customer" value="{{ $searchQuery ?? '' }}"
                            ...
                            <td>
                                <select
                                    ...
                                    <option value="pending"
                                        {{ $item->pembayaran->status_pembayaran === 'pending' ? 'selected' : '' }}>Pending
                                    </option>
                                    <option value="lunas"
                            ...
                            <td>
                                <select
                                    ...
                                    <option value="menunggu pembayaran"
                                        {{ $item->status_transaksi === 'menunggu pembayaran' ? 'selected' : '' }}>Menunggu
                                    </option>
                                    <option value="dikemas" {{ $item->status_transaksi === 'dikemas' ? 'selected' : '' }}>
                                        Dikemas</option>
                                    <option value="dikirim" {{ $item->status_transaksi === 'dikirim' ? 'selected' : '' }}>
                                        Dikirim</option>
                                    <option value="selesai" {{ $item->status_transaksi === 'selesai' ? 'selected' : '' }}>
                                        Selesai</option>
