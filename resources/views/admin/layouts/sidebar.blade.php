<div class="hidden md:flex flex-col fixed top-0 left-0 h-screen w-60 bg-gray-100 text-gray-600">
    ...
    <div class="flex flex-col justify-between h-full">
        ...
        <nav class="flex-1 p-2 overflow-y-auto space-y-2">
            ...
            {{-- Dashboard --}}
            <a href="/admin"
                class="flex text-sm items-center gap-3 px-3 py-2 rounded hover:bg-red-100 transition
            ...
            <details
                ...
                class="group">
                <summary
                    class="flex items-center gap-3 px-3 py-2 w-full rounded hover:bg-red-100 cursor-pointer
                    ...
                    <span class="ml-auto">
                        <i
                            class="fa-solid fa-chevron-right h-5 w-5 flex-shrink-0 transition-transform group-open:rotate-90"></i>
                    </span>
                </summary>
            ...
            {{-- Transaksi --}}
            <details {{ request()->is('transaksi*') || request()->is('metode_pembayaran*') ? 'open' : '' }}
                class="group">
                <summary
                    class="flex items-center gap-3 px-3 py-2 w-full rounded hover:bg-red-100 cursor-pointer
                ...
                <div class="flex flex-col space-y-1 mt-1">
                    ...
                    <a href="/pesanan"
                        class="flex items-center gap-3 px-4 py-2 rounded hover:bg-red-100 transition
        ...
        <div class="p-4 border-t">
            <a href="{{ route('auth.change-password.form') }}"
                class="flex items-center mb-3 gap-3 text-sm hover:font-bold">
            ...
            <form method="POST" action="{{ route('logout') }}" class="mt-2 flex items-center gap-3">
                ...
                <button type="button" id="logout-button" class="text-sm text-red-600 hover:font-bold">Logout</button>
            </form>
