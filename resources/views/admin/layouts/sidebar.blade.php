<div class="flex flex-col fixed top-0 left-0 h-screen w-60 bg-gray-100 text-gray-600">    {{-- Logo --}}
    ...
    <div class="flex flex-col justify-between h-full">
        <nav class="flex-1 p-2 overflow-y-auto space-y-6">
            ...
            {{-- Section: Admin Menu --}}
            <div class="flex flex-col space-y-1">
                <h2 class="text-xs font-semibold uppercase tracking-wide text-gray-500 px-3 mt-2">Menu Admin</h2>
                <hr class="border-t border-gray-300 mx-3">
                ...
                <a href="#" id="logout-button"
                    class="flex items-center gap-2 px-3 py-2 rounded hover:bg-red-100 transition text-sm text-red-600">
