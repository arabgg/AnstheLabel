                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <label for="foto-utama"
                            class="w-60 aspect-[4/5] border-2 border-dashed flex items-center justify-center cursor-pointer rounded">
                        ...
                        <div class="flex flex-wrap gap-3">
                            @foreach ($ukuran as $ukuran)
                                <label class="flex items-center gap-2 border px-3 py-1 rounded cursor-pointer">
                                    <input type="checkbox" name="ukuran[]" value="{{ $ukuran->ukuran_id }}">
                                    {{ $ukuran->nama_ukuran }}
                                </label>
                            @endforeach
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @foreach ($warna as $itemWarna)
                                <label class="flex items-center gap-2 border px-3 py-1 rounded cursor-pointer">
                                    <input type="checkbox" name="warna[]" value="{{ $itemWarna->warna_id }}">

                                    {{-- Kotak warna --}}
                                    <span class="w-6 h-6 rounded"
                                        style="background-color: {{ $itemWarna->kode_hex }}"></span>

                                    {{-- Kalau mau tetap menampilkan kode hex atau nama --}}
